...
Shader "PJAQ/Particles/Special/TuoWei_Blend" {
    Properties {
        ...
        _DissolverAmount ("Dissolver Amount", Range(0, 1)) = 0.6060354
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_7719 = (_MainTex_var.r*node_3273);
                clip(node_7719 - 0.5);
////// Lighting:
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,node_7719);
