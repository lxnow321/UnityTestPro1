...
////// Emissive:
                ...
                float3 emissive = ((_ColorAlpha.rgb*_DiffuseTexture_var.rgb)*i.vertexColor.rgb*_Brightness);
                ...
                float3 finalColor = emissive + ((node_1274*_C_BYcolor.rgb)*_N_BY_QD*_Brightness);
